...
namespace Keylol.Utilities
{
    ...
    public class NotNullHttpParameterBinding : HttpParameterBinding
    {
        ...
        /// </summary>
        /// <returns>
        /// true if this <see cref="T:System.Web.Http.Controllers.HttpParameterBinding"/> will read the entity body; otherwise, false.
        /// </returns>
        ...
        /// </summary>
        /// <param name="descriptor"><see cref="HttpParameterDescriptor"/></param>
